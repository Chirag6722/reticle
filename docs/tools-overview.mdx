...
<Note>
  ...
  surface is **18 tools, 21,468 bytes, ~5,400 tokens per turn**. Advertising all 48 costs **134,368
  bytes, ~33,600 tokens** — 6.3x more, charged on every message. Re-measure before quoting these;
  the surface grows.
</Note>
