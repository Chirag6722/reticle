...
`allOf` is the workhorse. "The signal fired **and** the console stayed clean **and** exactly one request went out" is a genuinely strong check, and it is one call.
