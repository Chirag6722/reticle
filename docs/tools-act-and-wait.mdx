...
The app itself declared success. This is the highest grade of evidence, and it requires [instrumenting your app](/integration-patterns) — which is the main reason to bother.
