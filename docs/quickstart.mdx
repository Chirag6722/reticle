...
Prefer to wire it yourself? See [Manual install](/getting-started). It is about ten lines, and worth reading once even if you let the agent do it, because it explains what the agent actually changed.
...
<CardGroup cols={2}>
  ...
  <Card title="Every tool" icon="list" href="/usage">
    The 16 tools your agent sees by default, and the 32 more it can reach on demand.
  </Card>
