...
- **Only \`reticle_act_and_wait\` and \`reticle_assert\` produce a verdict.** \`reticle_act\` and everything else move or read the app and prove nothing, so a session that ends without one of those two has no result however many tools it used. Measured across two days in the field: \`reticle_act\` made 319 calls and caught nothing, \`act_and_wait\` made 88 and caught 17 of the 28 defects found.
