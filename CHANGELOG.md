...
**Reticle was refusing to answer over captures that were completely intact.** 2.6.0 shipped the field that finally says _why_ a verdict came out the way it did, and the first data using it pointed straight back at us. No breaking changes.
